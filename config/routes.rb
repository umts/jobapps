Rails.application.routes.draw do
  ...
  get '/applications/:id', to: 'application_templates#show', defaults: { id_path: true }
  get '/applications/:department/:position', to: 'application_templates#show', defaults: { id_path: false }
