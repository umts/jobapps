  ...
  $("#fields-container")
    ...
    .each(function (index, element) {
      ...
      currentRow
        ...
        .attr({ name: newName("prompt", index), id: newID("prompt", index) });
      currentRow
        .find(".data-type select")
        .attr({ name: newName("data_type", index), id: newID("data_type", index) });
      currentRow
        .find(".field-required input")
        .attr({ name: newName("required", index), id: newID("required", index) });
    });
}
